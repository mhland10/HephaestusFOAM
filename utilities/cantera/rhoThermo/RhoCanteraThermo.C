...
void Foam::RhoCanteraThermo<BaseThermo>::calculate()
{    
    Info << "Using calculate method from RhoCanteraThermo" << nl;
...
template<class BaseThermo>
Foam::RhoCanteraThermo<BaseThermo>::RhoCanteraThermo
(
    const fvMesh& mesh,
    ...
    BaseThermo(mesh, phaseName)
{
    ...
    Foam::Info << "RhoCanteraThermo constructor from mesh & phaseName" << Foam::nl;
...
template<class BaseThermo>
void Foam::RhoCanteraThermo<BaseThermo>::correct()
{
    if (BaseThermo::debug)
    {
        InfoInFunction << endl;
